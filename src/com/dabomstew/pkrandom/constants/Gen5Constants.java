...
public class Gen5Constants {
    ...
    private static final int bw1AreaDataEntryLength = 249, bw2AreaDataEntryLength = 345, bw1EncounterAreaCount = 61,
    ...
    public static final List<Integer> bw2HiddenHollowUnovaPokemon = Arrays.asList(Species.watchog, Species.herdier,
            Species.liepard,
            ...
            Species.emolga, Species.karrablast, Species.alomomola, Species.galvantula, Species.klinklang,
            Species.elgyem,
            Species.litwick, Species.axew, Species.cubchoo, Species.shelmet, Species.stunfisk, Species.mienfoo,
            Species.druddigon, Species.golett, Species.pawniard, Species.bouffalant, Species.braviary,
            Species.mandibuzz,
    ...
    public static final int[] mulchIndices = { Items.growthMulch, Items.dampMulch, Items.stableMulch,
            Items.gooeyMulch };
    ...
    public static Integer getAbsolutePokeNumByBaseForme(int baseForme, int formNum) {
        return absolutePokeNumsByBaseForme.getOrDefault(baseForme, dummyAbsolutePokeNums).getOrDefault(formNum,
                baseForme);
    }
    ...
    // public static final Map<Integer, String> bw1ShopIndex = new HashMap<Integer,
    // String>() {1:"Check"};
    ...
    public static final List<Integer> evolutionItems = Arrays.asList(Items.sunStone, Items.moonStone, Items.fireStone,
            ...
            Items.ovalStone, Items.kingsRock, Items.deepSeaTooth, Items.deepSeaScale, Items.metalCoat,
            Items.dragonScale,
    ...
    public static final String introGraphicPrefix = "5A0000010000001700000001000000",
            bw1IntroCryPrefix = "0021009101910291", bw2IntroCryLocator = "3D020000F8B51C1C";
    ...
    private static List<Integer> setupAllHeldItems() {
        ...
        list.addAll(Arrays.asList(Items.airBalloon, Items.redCard, Items.absorbBulb, Items.cellBattery,
                ...
                Items.fightingGem, Items.poisonGem, Items.groundGem, Items.flyingGem, Items.psychicGem, Items.bugGem,
                Items.rockGem, Items.ghostGem, Items.dragonGem, Items.darkGem, Items.steelGem, Items.normalGem));
        list.addAll(Arrays.asList(Items.eviolite, Items.floatStone, Items.rockyHelmet, Items.ringTarget,
                Items.bindingBand));
        return Collections.unmodifiableList(list);
    }
    ...
    public static String blackBoxLegendaryCheckPrefix1 = "79F6BAEF07B0F0BDC046",
            blackBoxLegendaryCheckPrefix2 = "DEDB0020C04302B0F8BDC046",
    ...
    private static void setupAllowedItems() {
        ...
        allowedItems.banSingles(Items.libertyPass, Items.propCase, Items.dragonSkull, Items.lightStone,
                Items.darkStone);
        ...
        // Ban the shards in BW1; even the maniac only gives you $200 for them, and they
        ...
        regularShopItems
                .addAll(IntStream.rangeClosed(Items.ultraBall, Items.pokeBall).boxed().collect(Collectors.toList()));
        regularShopItems.addAll(IntStream.rangeClosed(Items.potion, Items.revive).boxed().collect(Collectors.toList()));
        regularShopItems
                .addAll(IntStream.rangeClosed(Items.superRepel, Items.repel).boxed().collect(Collectors.toList()));
        ...
        opShopItems
                .addAll(IntStream.rangeClosed(Items.blueFlute, Items.shoalShell).boxed().collect(Collectors.toList()));
        opShopItems
                .addAll(IntStream.rangeClosed(Items.tinyMushroom, Items.nugget).boxed().collect(Collectors.toList()));
        opShopItems.add(Items.rareBone);
        opShopItems.addAll(
                IntStream.rangeClosed(Items.lansatBerry, Items.rowapBerry).boxed().collect(Collectors.toList()));
        opShopItems.add(Items.luckyEgg);
        opShopItems.add(Items.prettyFeather);
        opShopItems.addAll(
                IntStream.rangeClosed(Items.balmMushroom, Items.casteliacone).boxed().collect(Collectors.toList()));
    }
